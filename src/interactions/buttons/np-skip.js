...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    if (!queuedTracks[0]) {
      queue.delete()
      return interaction.reply({ content: `Não tem uma próxima música, parando o bot!`, ephemeral: true });
    }
    ...
    try {
      ...
      interaction.reply({
        content: `❌ | Eita, deu merda aqui, na hora de skipar a música. Tenta de novo.`,
        ephemeral: true,
      });
    }
  },
